package com.clean_project.router;
...
//        });
    ...
    /**
     * Emits an event. When you pass  at the last argument, then the acknowledge is done.
     *
...
//        });
     ...
     * @return a reference to this object.
     */
    public Emitter emit(final String event) {
//        EventThread.exec(new Runnable() {
//            @Override
//            public void run() {
...
//        }
    ...
    private Object ack(final int id) {
